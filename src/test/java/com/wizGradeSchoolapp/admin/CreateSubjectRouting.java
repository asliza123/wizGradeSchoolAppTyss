...
public class CreateSubjectRouting {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement subList = driver.findElement(By.id("subject"));
		wul.select(subList, sNm);
		
		WebElement teList = driver.findElement(By.id("teacher"));
		wul.select(teList, tNm);
		
		driver.findElement(By.id("fee")).sendKeys(fees);
		driver.findElement(By.id("btnSubmit")).click();
